  ...
  <PageComponent>
    ...
    <div v-else>
      ...
      <div class="flex justify-center mt-5">
        <nav
          class="relative z-0 inline-flex justify-center rounded-ms shadow-sm" aria-label="Pagination">
          <a
            ...
            :class="[
              link.active ? 'z-10 bg-indigo-50 border-indigo-500 text-indigo-500'
